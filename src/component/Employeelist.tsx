...
export const Employeelist = () => {
    const { employees, removeEmployee, editEmployee } = useContext<InitialState>(GlobalContext);
    return (
        <Fragment>
                    ...
                    <div className="flex items-center bg-gray-100 mb-10 shadow" key={employee.id}>
                        ...
                        <div className="flex-auto text-right px-4 py-2 m-2">
                            <Link to={`/edit/${employee.id}`}>
                                <button onClick={() => editEmployee(employee)} className="bg-gray-300 hover:bg-gray-400 text-gray-800 font-semibold mr-3 py-2 px-4 rounded-full inline-flex items-center">
